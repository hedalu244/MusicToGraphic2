...
declare module '../../../index' {
    interface p5InstanceExtensions {
         ...
         *   @chainable
         */
        bezier(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number): p5_;
         ...
         *   @chainable
         */
        bezierDetail(detail: number): p5_;
         ...
         *   @chainable
         */
        curve(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number): p5_;
         ...
         *   @chainable
         */
        curveDetail(resolution: number): p5_;
         ...
         *   @chainable
         */
        curveTightness(amount: number): p5_;

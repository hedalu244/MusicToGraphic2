...
declare module '../../../index' {
    interface p5InstanceExtensions {
         ...
         *   @chainable
         */
        beginShape(kind?: BEGIN_KIND): p5_;
         ...
         *   @chainable
         */
        bezierVertex(x2: number, y2: number, x3: number, y3: number, x4: number, y4: number): p5_;
         ...
         *   @chainable
         */
        curveVertex(x: number, y: number): p5_;
         ...
         *   @chainable
         */
        curveVertex(x: number, y: number, z?: number): p5_;
         ...
         *   @chainable
         */
        quadraticVertex(cx: number, cy: number, x3: number, y3: number): p5_;
         ...
         *   @chainable
         */
        quadraticVertex(cx: number, cy: number, cz: number, x3: number, y3: number, z3: number): p5_;
         ...
         *   @chainable
         */
        vertex(x: number, y: number, z?: number): p5_;
         ...
         *   @chainable
         */
        vertex(x: number, y: number, z?: number, u?: number, v?: number): p5_;
         ...
         *   @chainable
         */
        normal(x: number, y: number, z: number): p5_;
    }
}

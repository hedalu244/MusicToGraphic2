...
declare module '../../index' {
    interface p5InstanceExtensions {
         ...
         *   @chainable
         */
        ambientLight(v1: number, v2: number, v3: number, alpha?: number): p5_;
         ...
         *   @chainable
         */
        ambientLight(gray: number, alpha?: number): p5_;
         ...
         *   @chainable
         */
        ambientLight(values: number[]): p5_;
         ...
         *   @chainable
         */
        specularColor(v1: number, v2: number, v3: number): p5_;
         ...
         *   @chainable
         */
        specularColor(value: string): p5_;
         ...
         *   @chainable
         */
        specularColor(values: number[]): p5_;
         ...
         *   @chainable
         */
        directionalLight(v1: number, v2: number, v3: number, x: number, y: number, z: number): p5_;
         ...
         *   @chainable
         */
        directionalLight(v1: number, v2: number, v3: number, direction: Vector): p5_;
         ...
         *   @chainable
         */
        directionalLight(color: Color | number[] | string, x: number, y: number, z: number): p5_;
         ...
         *   @chainable
         */
        directionalLight(color: Color | number[] | string, direction: Vector): p5_;
         ...
         *   @chainable
         */
        pointLight(v1: number, v2: number, v3: number, x: number, y: number, z: number): p5_;
         ...
         *   @chainable
         */
        pointLight(v1: number, v2: number, v3: number, position: Vector): p5_;
         ...
         *   @chainable
         */
        pointLight(color: Color | number[] | string, x: number, y: number, z: number): p5_;
         ...
         *   @chainable
         */
        pointLight(color: Color | number[] | string, position: Vector): p5_;
         ...
         *   @chainable
         */
        lightFalloff(constant: number, linear: number, quadratic: number): p5_;
